...
function footer() {
        ...
        return ( 
            ...
            <br/>
            <p id="para">
            Abdul's Store understands that online Tech shopping in Pakistan comes with its fair share of risks.
            ...
            Abdul's Store promises hassle free delivery right from the moment
            ...
            Or why not avail exclusive offers by downloading Abdul's Digital Wallet – which will be launched soon 
            ...
            <br/>
            <p id="para">
            Who says corporate purchases need to be a complicated affair? When you opt for Abdul's Store
             Corporate, you get an efficient and transparent solution for your business’ bulk purchasing needs
            </p>
            </div>
            <div className="col-4">
            <h4 id="head">
            Buy Value, not Just Goods with our Store  
            </h4>
            <p id="para">
            Abdul's Store does not just cater online shopping in Pakistan
            ...
            <p id="para">
            Get the chance to shop online from vendors around the world without leaving the Abdul's Store website. 
          ...
          <div className="col-4">
          <center>
            <p id="copyright">&copy; 2015 Abdul's.com</p>
            </center>
            </div>
            <div className="col-4"></div>
            </div></div>
